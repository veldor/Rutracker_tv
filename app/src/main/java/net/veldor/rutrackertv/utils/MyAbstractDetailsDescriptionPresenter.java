 ...
 */
public abstract class MyAbstractDetailsDescriptionPresenter extends Presenter {
            ...
            mPreDrawListener = new ViewTreeObserver.OnPreDrawListener() {
                ...
                public boolean onPreDraw() {
                   ...
                   /* if (mSubtitle.getVisibility() == View.VISIBLE
                    ...
                    int maxLines = titleLines > 1 ? mBodyMinLines : mBodyMaxLines;
                    maxLines = 16;
                    Log.d("surprise", "ViewHolder onPreDraw: maxLines is " + maxLines);
                    Log.d("surprise", "ViewHolder onPreDraw: body maxLines is " + mBody.getMaxLines());
